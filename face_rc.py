...
def make_database(model):
	"""
	Build a database containing one encoding vector for each person 
	allowed to enter the happy house. To generate the encoding 
	we use img_to_encoding(image_path, model) which basically runs 
...
database = make_database(FRmodel)

# Test verfication system
